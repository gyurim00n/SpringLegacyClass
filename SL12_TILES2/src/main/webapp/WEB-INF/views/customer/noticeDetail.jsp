...
<div id="content">
	...
	<div id="notice-article-detail" class="article-detail margin-large">
		...
		<dl class="article-detail-row half-row">
			...
			<dd class="article-detail-data half-data">${noticeVO.writer}</dd>
		</dl>
		<dl class="article-detail-row half-row">
		...
		<div class="article-content"> ${noticeVO.content}
			<%-- <img src="${noticeVO.filesrc}" /> 
							<br />
								${noticeVO.content}
 --%>
		</div>
...
<script>
		/* <a class="btn-del button" href="noticeDel.htm?seq=3">삭제</a> */
