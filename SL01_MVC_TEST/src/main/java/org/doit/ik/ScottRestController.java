...
public class ScottRestController {
	...
	// http://localhost/scott/dept/new + POST 부서추가요청
	...
	public ResponseEntity<String> insertDept(@RequestBody DeptDTO dto){
		log.info("🤩❤️❤️ ScottRestController.insertDept()...");
